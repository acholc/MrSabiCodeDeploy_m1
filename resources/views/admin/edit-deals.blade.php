										...
										<div class="col-md-12">
											<div class="row">
													...
													<div class="form-group">
                                                		...
                                                		@if($buisness['id'] == $deal['business_name'])
                                                		
                                                        <option value="{!! $buisness['id']  !!}" selected>{!! $buisness['title']  !!}</option>
                                                        
                                                        @else
                                                         <option value="{!! $buisness['id']  !!}">{!! $buisness['title']  !!}</option>
												...
												<div class="col-lg-4">
                                                    ...
                                                    <input type="text" name="discount" value="{{ $deal['discount'] }}" placeholder="" class="form-control"/>
                                                    ...
                                                    <input name="coupon" type="text" value="{{ $deal['coupon_code'] }}" placeholder="" class="form-control"/>
                                                    ...
                                                    <input name="title" type="text" value="{{ $deal['title'] }}" placeholder="" class="form-control" required/>
                                                    ...
                                                    <input name="description" type="text" value="{{ $deal['description'] }}" placeholder="" class="form-control" required/>
                                                    ...
                                                    <input name="price" type="text" value="{{ $deal['price'] }}" placeholder="" class="form-control" required/>
										...
										<div class="row">
                                                   <div class="col-lg-6">
                                                      <div class="form-group input-has-value">
                                                         ...
                                                         <input name="address" class="form-control" placeholder="" value="{{ $deal['address'] }}" type="text">
                                                      </div>
                                                   </div>
                                                   <div class="col-lg-6">
                                                      <div class="form-group input-has-value">
                                                         <label for="l30">City</label>
                                                         <input name="city" class="form-control" placeholder="" value="{{ $deal['city'] }}" type="text">
                                                      </div>
                                                   </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                      <div class="form-group input-has-value">
                                                		...
                                                		@if($country['country_id'] == $deal['country'])
                                                   ...
                                                   <div class="col-lg-6">
                                                      <div class="form-group">
                                                         ...
                                                         <select class="form-control state" id="state" name="state">
                                                          ...
                                                          {
                                                            if($state['state_id'] == $deal['state']) 
                                                            {
                                                              echo "<option>".$state['state_name']."</option>";
                                                            }
                                                          } ?>
                                                          <option id="selectedstate1"><?php echo $deal['state'];?></option>
                                                   ...
                                                   <div class="col-lg-6">
                                                      <div class="form-group input-has-value">
                                                         ...
                                                         <input name="phone" class="form-control" placeholder="" value="{{ $deal['phone'] }}" type="text">
                                                      </div>
                                                   </div>
                                                   <div class="col-lg-6">
                                                      <div class="form-group input-has-value">
                                                          @if($deal['image'])
                                                          <img id="blah" src="{{ url('/public/deal_images')}}/{{ $deal['image'] }}" alt="your image" />
                                                            @else
                                                            <img  src="{{ url('/public/deal_images')}}/dummimage.jpeg" alt="your image" />
                                                            @endif
 ...
 $(document).ready(function() {
    ...
    messages: 
        ...
        { 
             ...
             $.ajax({
                type:'POST',
                url:"{{route('adm.update_deal',$deal['id'])}}",

                ...
                <div class="container">
                    <div class="row">
                        <div class="page-title-left">
                            <h6 class="page-title-heading mr-0 mr-r-5">Edit Blog</h6>
                        </div>
                        <!-- /.page-title-left -->
					...
					<div class="col-md-12 widget-holder">
											...
											<div class="row">
												<div class="col-lg-12">
													<div class="form-group">
														...
														<input class="form-control"  placeholder="Title" type="text" value="{{ $blogdata->title }}" name="title">
													</div>
												</div>
                        ...
                        <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" data-toggle="tinymce" data-plugin-options='{ "height": 400 }'>{{ $blogdata->description }}</textarea>
                                </div>
                                <!-- /.widget-body -->
						...
						<div class="widget-bg">
                            <div class="widget-body clearfix">
                                        <div class="form-group">
                                            ...
                                            <?php 
                                                   $datas = array();
                                                    if(!empty($blogdata->category))
                                                    {
                                                      $datas = explode(',', $blogdata->category);
                                         ...
                                         <option <?php if(in_array($cat->id,$datas)){ echo "selected"; } ?> value ="{{ $cat->id }}"><?php echo $cat->category; ?></option>
                                        ...
                                        <div class="form-group mr-t-10">
    										...
    										<?php 
                                                   $datas = array();
                                                    if(!empty($blogdata->tag))
                                                    {
                                                      $datas = explode(',', $blogdata->tag);
                                           ...
                                           <select name="tag[]" class="m-b-10 form-control" multiple="multiple" data-placeholder="Choose" data-toggle="select2">
                                                   ...
                                                   ?>
                                                        ...
                                                        <option <?php if(in_array($tag->id,$datas)){ echo "selected"; } ?>  value ="{{ $tag->id }}"><?php echo $tag->tag_name; ?></option>
												...
												<div class="img-srt-bt">
												    @if($blogdata->image)
												    <img src="{{url('/')}}/public/blog_images/{{$blogdata->image}}" class="img-usr" id="image_upload_preview">
													@else
    ...
    messages: 
        ...
        { 
            ...
            $("label.help-block").removeClass("error");
             $.ajax({
                type:'POST',
                url:"{{route('adm.update_blog',$blogdata->id)}}",
